  ...
  const projects: Project[] = [
    {
      ...
      description: "Multi-factor authentication system with JWT and biometric security features. Implements advanced encryption and session management.",
    ...
    },
    {
      ...
      description: "Intelligent conversational AI for customer support with NLP capabilities and seamless integration with various platforms.",
    ...
    },
    {
      ...
      description: "Real-time dashboard for monitoring API performance and error tracking with customizable alerts and detailed analytics.",
    ...
    },
    {
      ...
      description: "Financial data visualization platform with predictive analytics showcasing real-time market trends and automated trading signals.",
                  ...
                  <CardContent className="p-0">
                        ...
                        {Array.from({ length: 10 }).map((_, i) => (
                          <span 
                            ...
                            className={cn(
                              ...
                              i < project.stats.complexity ? "bg-cyberpunk-green/70" : "bg-gray-700/30"
                            )}
                          ></span>
                        ))}
                      </div>
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-center mb-4">
                        <h3 className="text-xl font-bold text-white group-hover:text-cyberpunk-green transition-colors flex items-center">
                          {isHovered && <Sparkles size={16} className="mr-2 text-cyberpunk-green animate-pulse" />}
                          {project.title}
                        </h3>
                    ...
                    <div 
                      ...
                      style={{
                        ...
                        animation: isHovered ? 'gradient-slide 2s ease infinite' : 'none'
                      }}
                    ></div>
                  </CardContent>
                </Card>
