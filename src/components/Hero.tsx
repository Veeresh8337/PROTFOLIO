    ...
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl px-4 custom-cursor">
        <div className="glitch-text" data-text="VEERESH HINDIHOLI">
          <h1 className="text-5xl md:text-7xl font-glitch font-bold text-white mb-2 tracking-wider">
            VEERESH HINDIHOLI
          </h1>
        </div>
        <div className="h-16 my-6">
          <TypeAnimation
            className="TypingAnimation text-xl md:text-2xl font-mono mb-8"
            sequence={[
              "Hack the Future.", 
              1000,
        ...
        <a 
          href="#projects" 
          className="inline-block mt-8 px-6 py-3 bg-transparent border-2 border-cyberpunk-green text-cyberpunk-green hover:bg-cyberpunk-green/10 transition-all duration-300 rounded font-mono group"
        >
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-cyberpunk-green animate-bounce">
        <span className="text-sm font-mono">Scroll Down</span>
        <div className="w-5 h-8 border-2 border-cyberpunk-green rounded-full mx-auto mt-2 flex justify-center">
