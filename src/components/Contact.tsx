...
import { Github, Linkedin, Twitter, Mail, Phone, Send, Check, Loader } from 'lucide-react';
    ...
    <section id="contact" className="py-20 md:py-32 bg-cyberpunk-darker relative">
      ...
      <div className="section-container relative z-10">
        ...
        >
          {/* Contact Form */}
          <div className={cn(
            "bg-cyberpunk-dark p-6 rounded-md cyberpunk-border relative",
            hoverEffect ? "shadow-[0_0_15px_rgba(12,255,12,0.3)]" : "shadow-none",
            ...
            <h3 className="terminal-text text-lg mb-6 flex items-center">
              {'>'} <span className="typing-animation ml-2">Send_Message</span><span className="cursor"></span>
            </h3>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={cn(
                  ...
                  isSubmitting || isSuccess ? "bg-cyberpunk-green/20" : "hover:bg-cyberpunk-green/10",
              ...
              >
                <span className={cn(
                  ...
                  {isSubmitting ? (
                    ...
                    <>
                      <Send size={16} className="mr-2 group-hover:translate-x-1 transition-transform" /> Submit
                    </>
                  )}
                </span>
          ...
          <div className="space-y-6">
            <div className={cn(
              "bg-cyberpunk-dark p-6 rounded-md cyberpunk-border hover:shadow-[0_0_15px_rgba(12,255,12,0.3)]",
